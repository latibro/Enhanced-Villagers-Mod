package net.examplemod.inventoryinspector;

import dev.architectury.registry.menu.MenuRegistry;
import net.examplemod.ExampleMod;
import net.examplemod.inventoryinspector.villagerinventory.VillagerInventoryMenuProvider;
...
public class VillagerInventoryInspectorItem extends Item {
    public VillagerInventoryInspectorItem() {
        super(new Properties().tab(ExampleMod.EXAMPLE_TAB));
    }
