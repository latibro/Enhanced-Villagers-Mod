package net.examplemod.inventoryinspector.villagerinventory;
...
import static net.examplemod.ExampleMod.VILLAGER_INVENTORY_MENU;
...
public class VillagerInventoryMenu extends AbstractContainerMenu {
    ...
    public VillagerInventoryMenu(int id, Inventory playerInventory, Villager villager) {
        super(VILLAGER_INVENTORY_MENU.get(), id);
